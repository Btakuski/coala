...
^ Fabian, gimme something better than this :P
                                                                                                 

For this release, we have had 45 developers from around the world contributing
over 148 commits in the last 8 weeks.

Improving the API available for bear writers is one of the areas we've focussed
...
- A new ``CAN_FIX`` value ``Code Simplification`` has been introduced.
...
- Various other documentaion pages have been improved with new resources,
